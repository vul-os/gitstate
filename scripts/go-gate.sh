...
# gitstate-mcp).
MIN_PKGS="${MIN_PKGS:-10}"          # packages under cmd/ + internal/
MIN_TESTED_PKGS="${MIN_TESTED_PKGS:-8}"  # of those, ones carrying _test.go
MIN_GO_FILES="${MIN_GO_FILES:-94}" # .go files handed to gofmt
