...
function isGroup(item: NavEntry): item is NavGroupEntry {
...
export interface SidebarProps {
  onNavigate?: () => void
  /**
   * Distinguishes the desktop rail from the mobile drawer — both are in the
   * DOM at all times, and two navigation landmarks sharing one name is
   * ambiguous to a screen reader.
   */
  navLabel?: string
}

export function Sidebar({ onNavigate, navLabel = 'Primary' }: SidebarProps) {
  return (
