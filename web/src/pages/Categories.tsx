...
import { listCategories, createCategory, deleteCategory } from '../lib/api.ts'
import type { Category, CategorySource } from '../lib/types.ts'

const SOURCE_COLOR: Record<CategorySource, BadgeColor> = { taxonomy: 'indigo', local: 'teal', peer: 'blue' }
