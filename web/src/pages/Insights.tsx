...
import { listRepos, analytics } from '../lib/api.ts'
import {
...
import type { Analytics, ContributorStat, Repo, Totals } from '../lib/types.ts'
...
function ContributorTable({ rows }: { rows: ContributorStat[] }) {
  if (!rows?.length) {
...
export default function Insights() {
  ...
  const labelItems: BarListItem[] = useMemo(
