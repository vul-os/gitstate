...
import { listRepos, workItems } from '../lib/api.ts'
import type { WorkItem, WorkKind, WorkState } from '../lib/types.ts'
...
const KIND_ICON: Partial<Record<WorkKind, LucideIcon>> = { pr: GitPullRequest, issue: CircleDot, review: Eye }
const KIND_COLOR: Partial<Record<WorkKind, BadgeColor>> = { pr: 'indigo', issue: 'teal', review: 'yellow' }

async function loadItems(repoId: string): Promise<WorkItem[]> {
  if (!repoId) return []
