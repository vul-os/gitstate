<!-- title: API Reference | order: 51 | category: Reference | tier: Developers & contributors | summary: Every REST endpoint, grouped by area, with auth and org-scope conventions. -->
